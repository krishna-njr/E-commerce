...
import { createAddress, deleteAddress, getAddressById, getAddresses, updateAddress } from "../repositories/address.repository.js";

export const createAddressService = async (addressDetails) => {
   try {
      // schema validations : 
      const { fullName, street, city, state, postalCode, country, userId, phoneNumber } = addressDetails;
