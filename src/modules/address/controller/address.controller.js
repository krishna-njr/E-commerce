...
import { createAddressService, deleteAddressService, getAddressByIdService, getAddressesService, updateAddressService } from "../service/address.service.js";
...
export const updateAddressController = async (req, res) => {
  try {
    const addressDetails = req.body;
    // schema validation : 
    const updatedAddress = await updateAddressService(addressDetails);
...
export const deleteAddressController = async (req, res) => {
  try {
    const userId = req.params.id;
    // schema validation : 
    const deletedAddress = await deleteAddressService(userId);
