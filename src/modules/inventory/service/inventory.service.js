...
export const createInventoryService = async (data) => {
  try {
    ...
    // transaction to create product and inventory together, quantity is updated on both the product and inventory when product is added or updated:s
  } catch (err) {
...
export const updateInventoryService = async (productId, data) => {
  try {
